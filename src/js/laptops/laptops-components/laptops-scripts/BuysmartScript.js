...
<li>If you are ordering a computer for yourself, continue to the next step. If for someone else, skip to step 12.
</li>
...
<li>Review your order for accuracy.</li>
<li>Select Submit to complete your order.</li>
...
NOTE: A new level of approval is required for laptop orders called DCC Commodity Approver, which is required before the approval request is sent to the approving manager.  As a result, it may take slightly longer to process orders
</ol>
      </div>
    );
  }
